{* $Header: /cvsroot/bitweaver/_bit_citizen/templates/list_citizens.tpl,v 1.1 2008/08/27 16:20:01 lsces Exp $ *}
<div class="floaticon">
...
<div class="header">
<h1><a href="{$gBitLoc.CITIZEN_PKG_URL}list_citizens.php">{tr}Citizen Records{/tr}</a></h1>
</div>
