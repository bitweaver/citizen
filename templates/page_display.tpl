{strip}
<div class="body"{if $users_double_click eq 'y' and $dblclickedit eq 'y' and $gBitUser->hasPermission( 'bit_p_edit' )} ondblclick="location.href='{$smarty.const.CITIZEN_PKG_URL}edit.php?content_id={$contentInfo.content_id}';"{/if}>
	<div class="header">
